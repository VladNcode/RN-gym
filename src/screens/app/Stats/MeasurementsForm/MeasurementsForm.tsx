...
import { StatsMeasurmentsFormNavigationProp } from '../../../../constants';
...
interface StatsMeasurementsFormNavigationProps {
  navigation: StatsMeasurmentsFormNavigationProp;
}
...
const MeasurementsForm = ({ navigation }: StatsMeasurementsFormNavigationProps) => {
  const navigateBack = () => {
    navigation.goBack();
  };
    ...
    <Layout style={styles.container} level="1">
      <SafeAreaView style={styles.safeAreaContainer}>
        <Layout style={styles.layoutContainer} level="1">
          <TopNavigation title="Measurements form" alignment="center" accessoryLeft={BackAction} />
            ...
            <Controller
              ...
              render={({ field: { onChange, onBlur, value } }) => (
                <Input
                  ...
                  caption={
                    errors.waistCircumference && isSubmitted ? ErrorCaption('This field is required') : undefined
                  }
                />
              )}
            />
